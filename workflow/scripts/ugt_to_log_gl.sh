...
# $ bash ../ugt_to_log_gl.sh /crex/proj/snic2019-8-216/private/iter-pool-imp/runs/poolimputeSNPs/results/data/1/STU.Chr1.SNPs.pruned.sorted.vcf.gz /crex/proj/snic2019-8-216/private/iter-pool-imp/runs/poolimputeSNPs/results/data/1/STU.Chr1.SNPs.pruned.sorted.log-gl.vcf.gz
